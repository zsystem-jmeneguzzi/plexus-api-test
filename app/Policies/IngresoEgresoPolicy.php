...
class IngresoEgresoPolicy
{
    ...
    {
        return $user->hasRole('Super-Admin') || $user->can('resumen_List');
    }
    ...
    {
        return $user->hasRole('Super-Admin') || $user->can('resumen_Create');
    }

    public function update(User $user, IngresoEgreso $ingresoEgreso)
    {
        return $user->hasRole('Super-Admin') || $user->can('resumen_Update');
    }

    public function delete(User $user, IngresoEgreso $ingresoEgreso)
    {
        return $user->hasRole('Super-Admin') || $user->can('resumen_Delete');
    }
}
